...
func (k Keeper) RegisterCoin(
	...
	baseLower := strings.ToLower(coinMetadata.Base)
	if strings.Contains(baseLower, "nexus") || strings.Contains(baseLower, "anexus") ||
		strings.Contains(baseLower, "nxs") || strings.Contains(baseLower, "wnxs") {
