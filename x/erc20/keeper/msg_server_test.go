...
import (
	...
	"github.com/FDSLabs/Nexus/x/erc20/keeper"
...
func (suite *KeeperTestSuite) TestMsgConvertCoin_ValidateBasic() {
	...
	suite.Require().Equal("/nexus.erc20.v1.MsgConvertCoin", sdk.MsgTypeURL(&msg))
...
func (suite *KeeperTestSuite) TestMsgConvertERC20_ValidateBasic() {
	...
	suite.Require().Equal("/nexus.erc20.v1.MsgConvertERC20", sdk.MsgTypeURL(&msg))
	...
	testCases := []struct {
	...
	}{
		{
			...
			&types.MsgRegisterCoin{
				Authority:   "nexus1qypqxpq9qcrsszg2pvxq6rs0zqg3yyc5wgmgwp",
