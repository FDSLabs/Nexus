...
// It swaps the transferred IBC denom to anexus and
// convert the remaining balance to ERC20 tokens.
// If the balance of anexus is greater than the predefined value,
...
func (k Keeper) OnRecvPacket(
	...
	// and the asset transferred to the Nexus network will still remain in the Nexus network
	...
	// Get recipient addresses in `nexus1` and the original bech32 format
