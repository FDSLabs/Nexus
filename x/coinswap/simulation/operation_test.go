...
import (
	...
	"github.com/FDSLabs/Nexus/app/params"
	...
	"github.com/FDSLabs/Nexus/x/coinswap/simulation"
	"github.com/FDSLabs/Nexus/x/coinswap/types"
)

func TestWeightedOperations(t *testing.T) {
	nexus, ctx := createTestApp(t, false)
	cdc := types.ModuleCdc
	...
	s := rand.NewSource(2)
	r := rand.New(s)
	accs := getTestingAccounts(t, r, nexus, ctx, 10)
	...
	for i, w := range weightedOps {
		opMsg, _, _ := w.Op()(r, nexus.BaseApp, ctx, accs, ctx.ChainID())
...
func createTestApp(t *testing.T, isCheckTx bool) (*app.Nexus, sdk.Context) {
...
func getTestingAccounts(t *testing.T, r *rand.Rand, app *app.Nexus, ctx sdk.Context, n int) []simtypes.Account {
...
func getTestingValidator0(t *testing.T, app *app.Nexus, ctx sdk.Context, accounts []simtypes.Account) stakingtypes.Validator {
...
func getTestingValidator(t *testing.T, app *app.Nexus, ctx sdk.Context, accounts []simtypes.Account, commission stakingtypes.Commission, n int) stakingtypes.Validator {
	account := accounts[n]
