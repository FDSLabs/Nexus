...
const (
	Msg_LendingMarketProposal_FullMethodName = "/nexus.govshuttle.v1.Msg/LendingMarketProposal"
	Msg_TreasuryProposal_FullMethodName      = "/nexus.govshuttle.v1.Msg/TreasuryProposal"
)
