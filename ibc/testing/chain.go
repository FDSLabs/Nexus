...
// ChainIDPrefix defines the default chain ID prefix for nexus test chains
var ChainIDPrefixNexus = "nexus_12345-"
...
// Time management is handled by the Coordinator in order to ensure synchrony between chains.
// Each update of any chain increments the block header time for all chains by 5 seconds.
func NewTestChainNexus(t *testing.T, coord *Coordinator, chainID string) *TestChain {
	t.Helper()
	...
	app := SetupWithGenesisValSetNexus(t, valSet, []authtypes.GenesisAccount{acc}, chainID, balance)
