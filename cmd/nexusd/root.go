...
import (
	...
	cmdcfg "github.com/FDSLabs/Nexus/cmd/config"
	nexuskr "github.com/FDSLabs/Nexus/crypto/keyring"

	"github.com/FDSLabs/Nexus/version"
...
// NewRootCmd creates a new root command for nexusd. It is called once in the
// main function.
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	tempApp := app.NewNexus(
		log.NewNopLogger(),
		dbm.NewMemDB(),
		nil,
		true,
	...
	initClientCtx := client.Context{}.
		...
		WithKeyringOptions(nexuskr.Option()).
		WithViper(EnvPrefix)
...
func (a appCreator) appExport(
	...
	if height != -1 {
		nexusApp = app.NewNexus(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), false, appOpts)

		if err := nexusApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		nexusApp = app.NewNexus(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), false, appOpts)
	}

	return nexusApp.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs, modulesToExport)
}
