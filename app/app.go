...
import (
	...
	coinswapv1 "github.com/FDSLabs/Nexus/api/nexus/coinswap/v1"
	erc20v1 "github.com/FDSLabs/Nexus/api/nexus/erc20/v1"
	...
	_ "github.com/FDSLabs/Nexus/client/docs/statik"

	"github.com/FDSLabs/Nexus/app/ante"
	"github.com/FDSLabs/Nexus/x/epochs"
	epochskeeper "github.com/FDSLabs/Nexus/x/epochs/keeper"
	epochstypes "github.com/FDSLabs/Nexus/x/epochs/types"
	"github.com/FDSLabs/Nexus/x/erc20"
	erc20keeper "github.com/FDSLabs/Nexus/x/erc20/keeper"
	erc20types "github.com/FDSLabs/Nexus/x/erc20/types"

	"github.com/FDSLabs/Nexus/x/inflation"
	inflationkeeper "github.com/FDSLabs/Nexus/x/inflation/keeper"
	inflationtypes "github.com/FDSLabs/Nexus/x/inflation/types"
	"github.com/FDSLabs/Nexus/x/onboarding"
	onboardingkeeper "github.com/FDSLabs/Nexus/x/onboarding/keeper"
	onboardingtypes "github.com/FDSLabs/Nexus/x/onboarding/types"

	//govshuttle imports
	"github.com/FDSLabs/Nexus/x/govshuttle"
	govshuttlekeeper "github.com/FDSLabs/Nexus/x/govshuttle/keeper"
	govshuttletypes "github.com/FDSLabs/Nexus/x/govshuttle/types"

	"github.com/FDSLabs/Nexus/x/csr"
	csrkeeper "github.com/FDSLabs/Nexus/x/csr/keeper"
	csrtypes "github.com/FDSLabs/Nexus/x/csr/types"

	"github.com/FDSLabs/Nexus/x/coinswap"
	coinswapkeeper "github.com/FDSLabs/Nexus/x/coinswap/keeper"
...
var (
	_ runtime.AppI            = (*Nexus)(nil)
	_ servertypes.Application = (*Nexus)(nil)
	_ ibctesting.TestingApp   = (*Nexus)(nil)
)

// Nexus implements an extended ABCI application. It is an application
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".nexusd")

	// manually update the power reduction by replacing micro (u) -> atto (a) Nexus
...
// NewNexus returns a reference to a new initialized Ethermint application.
func NewNexus(
	logger log.Logger,
	db dbm.DB,
...
// use Nexus's custom AnteHandler
func (app *Nexus) setAnteHandler(txConfig client.TxConfig, maxGasWanted uint64, cdc codec.BinaryCodec, simulation bool) {
...
func (app *Nexus) Name() string { return app.BaseApp.Name() }

// PreBlocker updates every pre begin block
func (app *Nexus) PreBlocker(ctx sdk.Context, _ *abci.RequestFinalizeBlock) (*sdk.ResponsePreBlock, error) {
...
func (app *Nexus) BeginBlocker(ctx sdk.Context) (sdk.BeginBlock, error) {
	return app.ModuleManager.BeginBlock(ctx)
}

// EndBlocker updates every end block
func (app *Nexus) EndBlocker(ctx sdk.Context) (sdk.EndBlock, error) {
	return app.ModuleManager.EndBlock(ctx)
}

func (app *Nexus) Configurator() module.Configurator {
	return app.configurator
}

// InitChainer updates at chain initialization
func (app *Nexus) InitChainer(ctx sdk.Context, req *abci.RequestInitChain) (*abci.ResponseInitChain, error) {
...
func (app *Nexus) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *Nexus) ModuleAccountAddrs() map[string]bool {
...
// LegacyAmino returns Nexus's amino codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Nexus) LegacyAmino() *codec.LegacyAmino {
	return app.legacyAmino
}

// AppCodec returns Nexus's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Nexus) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns Nexus's InterfaceRegistry
func (app *Nexus) InterfaceRegistry() types.InterfaceRegistry {
	return app.interfaceRegistry
}

// TxConfig returns Nexus's TxConfig
func (app *Nexus) TxConfig() client.TxConfig {
	return app.txConfig
}

// AutoCliOpts returns the autocli options for the app.
func (app *Nexus) AutoCliOpts() autocli.AppOptions {
...
func (app *Nexus) DefaultGenesis() map[string]json.RawMessage {
...
func (app *Nexus) GetKey(storeKey string) *storetypes.KVStoreKey {
	return app.keys[storeKey]
}

// GetStoreKeys returns all the stored store keys.
func (app *Nexus) GetStoreKeys() []storetypes.StoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Nexus) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *Nexus) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Nexus) GetSubspace(moduleName string) paramstypes.Subspace {
	subspace, _ := app.ParamsKeeper.GetSubspace(moduleName)
	return subspace
}

// SimulationManager implements the SimulationApp interface
func (app *Nexus) SimulationManager() *module.SimulationManager {
	return app.sm
}

// RegisterAPIRoutes registers all application module routes with the provided
// API server.
func (app *Nexus) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *Nexus) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

func (app *Nexus) RegisterTendermintService(clientCtx client.Context) {
...
func (app *Nexus) RegisterNodeService(clientCtx client.Context, cfg config.Config) {
...
func (app *Nexus) GetBaseApp() *baseapp.BaseApp {
	return app.BaseApp
}

// GetStakingKeeper implements the TestingApp interface.
func (app *Nexus) GetStakingKeeper() ibctestingtypes.StakingKeeper {
	return app.StakingKeeper
}

// GetIBCKeeper implements the TestingApp interface.
func (app *Nexus) GetIBCKeeper() *ibckeeper.Keeper {
	return app.IBCKeeper
}

func (app *Nexus) GetErc20Keeper() erc20keeper.Keeper {
	return app.Erc20Keeper
}

func (app *Nexus) GetCoinswapKeeper() coinswapkeeper.Keeper {
	return app.CoinswapKeeper
}

func (app *Nexus) GetOnboardingKeeper() *onboardingkeeper.Keeper {
	return app.OnboardingKeeper
}

// GetScopedIBCKeeper implements the TestingApp interface.
func (app *Nexus) GetScopedIBCKeeper() capabilitykeeper.ScopedKeeper {
	return app.ScopedIBCKeeper
}

// GetTxConfig implements the TestingApp interface.
func (app *Nexus) GetTxConfig() client.TxConfig {
	return app.txConfig
}

func (app *Nexus) FinalizeBlock(req *abci.RequestFinalizeBlock) (*abci.ResponseFinalizeBlock, error) {
...
func (app *Nexus) BlockedAddrs() map[string]bool {
...
func (app *Nexus) setupUpgradeHandlers() {
	...
	// Add future store upgrades here
	// Currently no upgrades to apply
}
